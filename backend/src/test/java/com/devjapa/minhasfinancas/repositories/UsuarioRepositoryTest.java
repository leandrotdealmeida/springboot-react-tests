...
public class UsuarioRepositoryTest {
	...
	public void deveBuscarUmUsuarioPorEmail() {
		...
		// verificação
		Optional<Usuario> usuarioOP = repository.findByEmail("usuario@email.com");
		
		Assertions.assertThat(usuarioOP.isPresent()).isTrue();
	...
	public void deveRetornarVazioAoBuscarUsuarioPorEmailQuandoNaoExistenaBase() {
		...
		Assertions.assertThat(usuarioOP.isPresent()).isFalse();
